...
{
	// TF2 milestone achievements that grant in-game items (weapons/cosmetics)
	// Each class has 3 milestones unlocking weapons; plus special item achievements
	static const char* s_vItemAchievements[] = {
		// Scout milestones (Sandman, Force-A-Nature, Bonk! Atomic Punch)
		"TF_SCOUT_MILESTONE_1", "TF_SCOUT_MILESTONE_2", "TF_SCOUT_MILESTONE_3",
		// Soldier milestones (Buff Banner, Direct Hit, Equalizer)
		"TF_SOLDIER_MILESTONE_1", "TF_SOLDIER_MILESTONE_2", "TF_SOLDIER_MILESTONE_3",
		// Pyro milestones (Flare Gun, Backburner, Axtinguisher)
		"TF_PYRO_MILESTONE_1", "TF_PYRO_MILESTONE_2", "TF_PYRO_MILESTONE_3",
		// Demoman milestones (Chargin' Targe, Scottish Resistance, Ullapool Caber)
		"TF_DEMOMAN_MILESTONE_1", "TF_DEMOMAN_MILESTONE_2", "TF_DEMOMAN_MILESTONE_3",
		// Heavy milestones (Natascha, Sandvich, Killing Gloves of Boxing)
		"TF_HEAVY_MILESTONE_1", "TF_HEAVY_MILESTONE_2", "TF_HEAVY_MILESTONE_3",
		// Engineer milestones (Frontier Justice, Gunslinger, Wrangler)
		"TF_ENGINEER_MILESTONE_1", "TF_ENGINEER_MILESTONE_2", "TF_ENGINEER_MILESTONE_3",
		// Medic milestones (Blutsauger, Kritzkrieg, Ubersaw)
		"TF_MEDIC_MILESTONE_1", "TF_MEDIC_MILESTONE_2", "TF_MEDIC_MILESTONE_3",
		// Sniper milestones (Huntsman, Razorback, Jarate)
		"TF_SNIPER_MILESTONE_1", "TF_SNIPER_MILESTONE_2", "TF_SNIPER_MILESTONE_3",
		// Spy milestones (Ambassador, Dead Ringer, Cloak and Dagger)
		"TF_SPY_MILESTONE_1", "TF_SPY_MILESTONE_2", "TF_SPY_MILESTONE_3",
	};
	...
	I::SteamUserStats->RequestCurrentStats();
	for (auto pszName : s_vItemAchievements)
	{
		// Find achievement by name and award it
		for (int i = 0; i < pAchievementMgr->GetAchievementCount(); i++)
		{
			auto pAch = pAchievementMgr->GetAchievementByIndex(i);
			if (pAch && strcmp(pAch->GetName(), pszName) == 0)
			{
				pAchievementMgr->AwardAchievement(pAch->GetAchievementID());
				break;
			}
		}
	}
